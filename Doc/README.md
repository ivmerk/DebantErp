...
| [orders-labor-costs.md](orders-labor-costs.md) | Заказы и трудозатраты | ⚙️ бэкенд готов, UI нет |
| [production-rates.md](production-rates.md) | Расценки | 🧩 каркас (схема/модель/DAL) |
...
- **Рабочая область** (`/workspace`) — хаб выбора сущности. Разделы вынесены в
  ...
  (общий `PageSize`). Готовые разделы: «Работники», «Специальности»,
  «Операции». «Расценки» и «Заказы» — заглушки.
